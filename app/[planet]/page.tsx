...
export default function PlanetPage({ params }: { params: { planet: string } }) {
  ...
  return (
    <main className="flex flex-col min-h-screen items-center text-white bg-[#070724] bg-gradient-radial h-full bg-stars md:px-[39px]">
      <section className='flex flex-col items-center justify-center md:grid md:grid-rows-1 md:grid-cols-2'>
        <div className='flex justify-center gap-[16px] border-y md:border-none mb-[0] w-full pt-[20px] mb-[64px] md:mt-[15px] md:flex-col md:row-start-2 md:row-end-3 md:col-start-2'>
